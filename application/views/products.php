					...
					<div class=" top-products">
						<div class="col-md-3 md-col">
							<div class="col-md">
								...
								<div class="top-content">
									<h5><a href="<?php echo site_url('singleController')?>">Simply random</a></h5>
									<div class="white">
						...
						<div class="col-md-3 md-col">
							<div class="col-md ">
								...
								<div class="top-content">
									<h5> <a href="<?php echo site_url('singleController')?>">Classical Latin</a></h5>
									<div class="white">
										<a href="<?php echo site_url('singleController')?>" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md ">
								...
								<div class="top-content">
									<h5><a href="<?php echo site_url('singleController')?>">Standard chunk</a></h5>
									<div class="white">
										<a href="<?php echo site_url('singleController')?>" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
