				...
				<ul class="nav">
					...
					<li ><a href="#" >Laptops & Notebooks</a>
						<ul class="drop">
							...
							<li><a href="<?php echo site_url('ProductController')?>">Intel(5)</a></li>
						</ul>
						</li> 						
	...
	<div class="banner-mat">
		<div class="container">
			...
			<ul class="rslides" id="slider1">
             <?php
			 $sliderImgUrl=base_url()."images/";
			   foreach ( $sliders as $key=> $slider){
				   if($key<3){
				   $url=$sliderImgUrl.$slider['img'];
			 ...
			 ?>
				...
				<div class="banner-bottom">
					<div class="banner-matter">
						...
						<a href="<?php echo site_url('singleController')?>" class="hvr-shutter-in-vertical ">Purchase</a>
					</div>
					<div class="purchase">
						<a href="<?php echo site_url('singleController')?>" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">Purchase</a>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>				
				...
				<div class="content-top">
					...
					<div class="content-top-in">
						...
						foreach ( $sliders as $key=> $slider){
							...
							<div class=\"col-md\">
								<a href=\"singleController\"><img src=\"$url\" alt=\"\" />	</a>
								<div class=\"top-content\">
									<h5><a href=\"singleController\">$name</a></h5>
									<div class=\"white\">
										<a href=\"singleController\" class=\"hvr-shutter-in-vertical hvr-shutter-in-vertical2\">ADD TO CART</a>
										<p class=\"dollar\"><span class=\"in-dollar\">$</span><span>$price</span></p>
										<div class=\"clearfix\"></div>
									</div>
								</div>
							</div>
					...
					<ul id="flexiselDemo2">
						...
						foreach ( $sliders as $key=> $slider){
							if($key>10&& $key<=14){
								...
								$price=$slider['price'];
								$name=$slider['name'];
								echo " <li><div class='col-md men'>
								<a href='singleController' class='compare-in '><img src='$url' alt='' />
